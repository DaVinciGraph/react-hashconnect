...
import { TokenFreezeTransaction, TransactionReceipt } from "@hashgraph/sdk";

const TokenFreezeAccountModal: FC<IModalProps> = ({ setLoadModal }) => {
        ...
        <Modal width="sm:max-w-2xl" setShow={setLoadModal}>
            <article className="px-4 py-2 w-80">
                <div className="border-b border-gray-200 bg-white px-4 py-4 sm:px-6 text-center">
                    <h3 className="text-lg font-medium leading-6 text-gray-900">Freeze Token</h3>
                </div>
...
export default TokenFreezeAccountModal;