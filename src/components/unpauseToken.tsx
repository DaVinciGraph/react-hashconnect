...
import { TokenUnpauseTransaction, TransactionReceipt } from "@hashgraph/sdk";

const UnpauseTokenModal: FC<IModalProps> = ({ setLoadModal }) => {
        ...
        <Modal width="sm:max-w-2xl" setShow={setLoadModal}>
            <article className="px-4 py-2">
                <div className="border-b border-gray-200 bg-white px-4 py-4 sm:px-6 text-center">
                    <h3 className="text-lg font-medium leading-6 text-gray-900">Unpause token</h3>
                </div>
...
export default UnpauseTokenModal;